...
public class VehicleForm extends JFrame implements ActionListener {
    ...
    private void saveToFile()
    {
        ...
        try(FileWriter writer = new FileWriter("week24\\vehicles.txt"))
        {
            for(Vehicle vh: vehicles)
            {
                // String name, int speed, int seats, double fuelEfficiency, double tankCapacity
                //String name, int speed, boolean hasCarrier, int gearCount, double distance
    ...
    private void loadFromFile() 
    {
          ...
          try(BufferedReader reader = new BufferedReader(new FileReader("vehicles.txt")))
          {
              ...
              while((line = reader.readLine())!= null)
              {
                 ...
                 String type= parts[0].trim(); // Bike or Car
                 ...
                 else if(type.equalsIgnoreCase("Bike"))
                 {
                     ...
                     Vehicle vh = new Bike(name, speed, carrier, gear, distance);
                     vehicles.add(vh);
                 }
              }
          }
    ...
    private void deserializeFromFile()
    {
         ...
         try(ObjectInputStream ois = new ObjectInputStream(new FileInputStream("vehicles.dat")))
         {
            ...
            JOptionPane.showMessageDialog(this, "File deserialized successfully!");
            displayTable();
         }
         catch(Exception ee)
         {
